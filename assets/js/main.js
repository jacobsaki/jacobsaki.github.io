!function() {
    ...
    const r = new class {
        ...
        handleMouse(t)
        {
            this.currMouseX = t.clientX,
            this.currMouseY = t.clientY
        }
        handleOrientation(t)
        {
        ...
        update()
        {
            const {currWidth: t, currHeight: e, currMouseX: r, currMouseY: i, currAlpha: o, currBeta: a, currGamma: s, currDevicePixelRatio: c} = this;
            if (this.updating)
                return !1;
            this.scrollChange = this.sizeChange = this.mouseChange = this.positionChange = this.orientationChange = this.devicePixelRatioChange = !1,
            this.windowXVelocity.length > 5 && this.windowXVelocity.shift(),
            this.windowXVelocity.push(window.screenX - this.lastWindowX),
            n(this.windowXVelocity) != this.lastWindowXVelocity && (this.lastWindowXVelocity = n(this.windowXVelocity), this.positionChange = !0),
            window.screenX != this.lastWindowX && (this.positionChange = !0, this.lastWindowX = window.screenX),
            this.windowYVelocity.length > 5 && this.windowYVelocity.shift(),
            this.windowYVelocity.push(window.screenY - this.lastWindowY),
            n(this.windowYVelocity) != this.lastWindowYVelocity && (this.lastWindowYVelocity = n(this.windowYVelocity), this.positionChange = !0),
            window.screenY != this.lastWindowY && (this.positionChange = !0, this.lastWindowY = window.screenY),
            window.pageXOffset == this.lastX && 0 != this.scrollXVelocity && (this.scrollXVelocity = 0, this.scrollChange = !0),
            window.pageYOffset == this.lastY && 0 != this.scrollYVelocity && (this.scrollYVelocity = 0, this.scrollChange = !0),
            window.pageXOffset != this.lastX && (this.scrollChange = !0, this.scrollXVelocity = Math.floor(window.pageXOffset - this.lastX), this.lastX = window.pageXOffset),
            window.pageYOffset != this.lastY && (this.scrollChange = !0, this.scrollYVelocity = Math.floor(window.pageYOffset - this.lastY), this.lastY = window.pageYOffset),
            t != this.lastWidth && (this.lastWidth = t, this.scrollHeight = document.body.scrollHeight, this.sizeChange = !0),
            ...
            n(this.mouseXVelocity) != this.lastMouseXVelocity && (this.lastMouseXVelocity = n(this.mouseXVelocity), this.mouseChange = !0),
            r != this.lastMouseX && (this.lastMouseX = r, this.mouseChange = !0),
            this.mouseYVelocity.length > 5 && this.mouseYVelocity.shift(),
            this.mouseYVelocity.push(i - this.lastMouseY),
            n(this.mouseYVelocity) != this.lastMouseYVelocity && (this.lastMouseYVelocity = n(this.mouseYVelocity), this.mouseChange = !0),
            i == this.lastMouseY && 0 == n(this.mouseYVelocity) || (this.lastMouseY = i, this.mouseChange = !0),
            o != this.lastAlpha && (this.lastAlpha = o, this.orientationChange = !0),
            a != this.lastBeta && (this.lastBeta = a, this.orientationChange = !0),
            s != this.lastGamma && (this.lastGamma = s, this.orientationChange = !0),
            (this.positionChange || this.sizeChange) && (this.currDevicePixelRatio = Math.max(window.devicePixelRatio || 1, 1), this.currDevicePixelRatio !== this.lastDevicePixelRatio && (this.devicePixelRatioChange = !0, this.lastDevicePixelRatio = this.currDevicePixelRatio)),
            (this.scrollChange || this.sizeChange || this.mouseChange || this.positionChange || this.orientationChange || this.devicePixelRatioChange) && this.callbacks.forEach(t => t(this.formatData())),
            this.updating = !1,
    ...
    var u = new class {
        constructor(t)
        {
            ...
            e.registeredPaths.length && e.registeredPaths.forEach(t => {
    ...
    var b = "loading--in",
        x = new (function() {
            function t() {
                ...
                this.loaderEl && (this.loaderMask = this.loaderEl.querySelector(".loading__mask"), document.querySelector("html").classList.add("is-loading"))
            }
            return d(t, [{
                key: "openLoader",
                value: function(t) {
    ...
    var Y = function() {
        ...
        N = function(t) {
            return function(e) {
                if ("string" != typeof e)
                    return e;
                for (var n, r = {}, i = (n = e, n.substring(n.indexOf("(") + 1, n.lastIndexOf(")"))).split(/,\s*/), o = 0; o < 4; o++)
            ...
            createTransformer: function(t) {
                ...
                return function(t) {
                    for (var r = e, o = 0; o < n; o++)
                        r = r.replace(o < i ? "${c}" : "${n}", o < i ? nt.transform(t[o]) : E(t[o]));
                    return r
                }
            },
    ...
    function Vt(t) {
        for (var e = it.parse(t), n = e.length, r = 0, i = 0, o = 0, a = 0; a < n; a++)
        ...
        Wt = (Ct(0, 1), function(t) {
            ...
            return function(t) {
                ...
                function u(t, e) {
                    ...
                    var n = o[t];
                    o[t] = e,
                    o[t] !== n && (-1 === s.indexOf(t) && s.push(t), c || (c = !0, vt.render(l.render)))
                }
                var l = {
                    get: function(t, n) {
    ...
    function ye(t, e, n, r, i, o) {
        ...
        for (var g in m) {
            if ("transform" === g)
                i.style.transform = m[g];
            else
                i[o && !fe.has(g) ? Ht(g) : g] = m[g]
        }
    ...
    var _e = function() {
        ...
        Ce = function() {
            return function(t, e) {
                ...
                this.onComplete = i,
                e.update && r && r.length && r.forEach((function(t) {
                ...
                var n,
                    ...
                    k = function() {
                        ...
                        n = vt.update((function(t) {
                            ...
                            M += r,
                            X(),
                            !(e = R && M > a + g) || (!e || d || l || p) && (M = a - (M - g), d && L < d ? (L++, 1) : l && O < l ? (O++, E(), 1) : p && C < p && (C++, E(C % 2 != 0), 1)) || (yt.update(n), i && vt.update(i, !1, !0))
                        }), !0)
                    },
                    q = function() {
                        R = !1,
    ...
    var Je = 0,
        ...
        rn = (new (function() {
            function t() {
                ...
                this.menuEl && this.triggerEl.addEventListener("click", (function(t) {
                    t.preventDefault(),
                    e.toggleMenu()
                }))
            }
            return d(t, [{
                ...
                value: function() {
                    ...
                    !0 === t && (this.triggerEl.classList.add("is-active"), this.menuEl.classList.add("is-open"), document.querySelector("html").classList.add("lock-scroll"), this.triggerEl.setAttribute("aria-expanded", !0), this.closeLabelEl.setAttribute("aria-hidden", !1), this.openLabelEl.setAttribute("aria-hidden", !0)),
                    !1 === t && (this.triggerEl.classList.remove("is-active"), this.menuEl.classList.remove("is-open"), document.querySelector("html").classList.remove("lock-scroll"), this.triggerEl.setAttribute("aria-expanded", !1), this.closeLabelEl.setAttribute("aria-hidden", !0), this.openLabelEl.setAttribute("aria-hidden", !1))
                }
            }]), t
        }())).toggleMenu,
        on = function(t) {
            g((t || document.querySelector("body")).querySelectorAll('a[href^="/"], a[href^="#"]')).filter((function(t) {
                return !t.hasAttribute("data-rekishi-skip")
            })).forEach((function(t) {
                t.addEventListener("click", (function(e) {
                    e.preventDefault();
                    var n = t.getAttribute("href");
                    if (window.location.pathname == n || window.location.pathname == n + "/")
                        return rn(!1), !1;
                    u.push(n)
                }))
            }))
    ...
    var sn = function(t) {
            ...
            g(document.querySelectorAll("[data-reveal]")).forEach((function(t) {
                ...
                n.changed && (t.dataset.offset = Math.floor(t.getBoundingClientRect().top + window.pageYOffset)),
                e.changed && e.bottom > o + n.y / 4 && !i && (t.classList.add(r), delete t.dataset.reveal, delete t.dataset.offset)
            }))
        },
        cn = function(t) {
            if (t) {
        ...
        un = function(t) {
            ...
            M((function() {
                ...
                (t = e, fetch(t).then((function(t) {
                    if (!t.ok)
                        throw new Error("Ajax page-load failed!");
                    return t.text()
                }))).then((function(t) {
    ...
    i((function(t) {
        ...
        n.changed && g(document.querySelectorAll("[data-prlx]")).forEach((function(t) {
            ...
            t.style.transform = "translate3d(".concat(n.top * i, "px, ").concat(n.top * o, "px, 0)")
        }))
    })),
    i((function(t) {
        var e = t.mouse,
        ...
        if (i) {
            ...
            if (a && (o = {
                ...
                l.style.transform = "translateX(".concat(Math.ceil(10 * O), "px)"),
                h.style.transition = "all 100ms 10ms ease-out",
                h.style.transform = "translateY(".concat(Math.ceil(10 * _) < -3 ? -3 : Math.ceil(10 * _), "px)"),
                s.style.transform = "translateY(".concat(L < 0 ? Math.ceil(1 * L) : Math.ceil(3 * L), "px)"),
                ...
                v.style.transform = "translateX(".concat(C < 0 ? Math.ceil(1 * C) : Math.ceil(-1 * C), "px)"),
                y.style.transform = "translateX(".concat(C < 0 ? Math.ceil(-1 * C) : Math.ceil(1 * C), "px)"),
                d.style.transform = "translateY(".concat(C < 0 ? -5 + Math.ceil(2 * C) : -5 + Math.ceil(5 * C), "px)"),
                m.style.transform = "translateY(".concat(C < 0 ? -3 + Math.ceil(-5 * C) : -3 + Math.ceil(-3 * C), "px)"),
                w.style.transform = L < 0 ? "scaleY(".concat(1 + -1 * L * .025, ")") : "scaleY(".concat(1 - .025 * L);
                var P = en.y,
                    Y = en.duration,
                    R = tn.d;
    ...
    requestAnimationFrame((function t() {
        if (document.querySelector(".clock")) {
            var e = new Date,
                ...
                r = e.getHours() / 12 * 360;
            document.querySelector(".clock-pivot__hand--minute").parentElement.style.transform = "rotate(".concat(n, "deg)"),
            document.querySelector(".clock-pivot__hand--hour").parentElement.style.transform = "rotate(".concat(r, "deg)")
        }
